import { Cd as parseAxisParam, Dd as sizeFromShape, _s as encodeString, bo as buffer, cd as getArrayFromDType, fs as TensorBuffer, i as fromUint8ToStringArray, lt as isSliceContinous, nd as assert, od as computeStrides, ot as assertParamsValid, r as fromStringArrayToUint8, st as computeFlatOffset, ut as parseSliceParams, vu as Slice, ws as fingerPrint64, xd as makeZerosTypedArray } from "./dist-CN8OvvZ-.js";
...
function rangeImpl(start, stop, step, dtype) {
	if (start === stop || start < stop && step < 0 || stop < start && step > 1) return makeZerosTypedArray(0, dtype);
	const values = makeZerosTypedArray(Math.abs(Math.ceil((stop - start) / step)), dtype);
	if (stop < start && step === 1) step = -1;
	values[0] = start;
...
function sliceImpl(vals, begin, size, shape, dtype) {
	...
	const inBuf = buffer(shape, dtype, dtype === "string" ? fromUint8ToStringArray(vals) : vals);
...
//#endregion
export { slice as a, rangeImpl as c, stringNGramsImpl as i, concatImpl as l, stringToHashBucketFastImpl as n, sliceConfig as o, stringSplitImpl as r, sliceImpl as s, uniqueImpl as t, assertNotComplex as u };

//# sourceMappingURL=Unique_impl-DlqogCzK.js.map